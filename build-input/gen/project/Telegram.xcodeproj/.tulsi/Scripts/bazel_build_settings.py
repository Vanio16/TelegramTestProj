...
BUILD_SETTINGS = BazelBuildSettings(
    '/Users/ivanzaharov/Desktop/learning/Telegram-iOS/build-input/gen/project/bazel',
    '/private/var/tmp/_bazel_ivanzaharov/8b6365b15b532e8d68fdac91020a5fd4/execroot/__main__',
    '/private/var/tmp/_bazel_ivanzaharov/8b6365b15b532e8d68fdac91020a5fd4',
    'ios_x86_64',
    {
        'watchos_x86_64': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/ivanzaharov/Library/Application Support/Tulsi/0.20220209.88/Bazel',
    ...
    BazelFlagsSet(
        flags = BazelFlags(
            startup = [],
            build = [
                '--override_repository=build_configuration=/Users/ivanzaharov/Desktop/learning/Telegram-iOS/build-input/configuration-repository',
                ...
                '--define=telegramVersion=9.4.2',
                '--disk_cache=/Users/ivanzaharov/telegram-bazel-cache',
                '--//Telegram:disableExtensions',
            ],
        ),
    ),
